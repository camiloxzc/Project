@extends('layouts.main', ['activePage' => 'Compras', 'titlePage' => 'Registro de compras'])
@section('content')
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <form action="/compras/{{$compras->idcompra}}" method="post" class="form-horizontal">
          @csrf
          @METHOD('PUT')
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="date" class="form-control" name="fecha" placeholder="Ingrese fecha " value="{{ $compras->fecha }}"  autofocus>
                  @if ($errors->has('fecha'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="preciototal" placeholder="Ingrese precio" value="{{ $compras->preciototal }}">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="iva" placeholder="Ingrese el iva" value="{{ $compras->iva }}">
                  @if ($errors->has('iva'))
            ...
            <div class="card-footer ml-auto mr-auto">
              <button type="submit" class="btn btn-primary">Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="{{route('compras.index')}}">
