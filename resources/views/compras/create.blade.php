          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="date" class="form-control" name="fecha" placeholder="Ingrese fecha "  autofocus>
                  @if ($errors->has('fecha'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="preciototal" placeholder="Ingrese precio" >
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="iva" placeholder="Ingrese el iva" >
                  @if ($errors->has('iva'))
